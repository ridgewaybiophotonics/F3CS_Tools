...
.LC2:
    ...
    .byte   0
	.text
.globl bits_2048_2048_3
	.type	bits_2048_2048_3, @function
bits_2048_2048_3:
	pushl	%ebp
    movl	%esp, %ebp
	movl	8(%ebp), %eax #one
...
.L3:
    ...
    incl    %edx
    incl    %edx
 	lddqu   (%eax, %edx,8), %xmm1     #    scratch data to xmm1
    movdqa  %xmm1, %xmm7
    psrldq  $1, %xmm7
    paddb   %xmm7, %xmm1
    pand    %xmm5, %xmm1
    ...
    movdqa  .LC1, %xmm5
    movl	16(%ebp), %eax    #    Get scratch memory address for colour two
    movl    $0, %edx
    movl	28(%ebp), %ecx
	...
	popl	%ebp
	ret
	.size	bits_2048_2048_3, .-bits_2048_2048_3
