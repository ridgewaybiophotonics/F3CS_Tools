 ...
 *
 *  DAQ.c
 *  This code provides the commandline interface for the fast, robust data
 *  acquisition process.  Calls the TTL/SSE loops from fast_sse_ttl_loops.c.
 *
 */
...
int main(int argc, char *argv[])    {
	...
	if(argc != 4)  {
        printf("Usage: F3CS_DAQ tag_string time(s) maxcounts(kHz, int)\ne.g. >rxn_3c expt1 1000 800\n");
        return 1;
    }
	...
	bits_2048_16_3_c(&result_one[0], &result_two[0], &result_thr[0], &rem[0], &data[0]);
